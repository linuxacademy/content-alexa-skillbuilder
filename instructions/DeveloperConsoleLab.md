...
ASK CLI **will create the skill and the Lambda function for you**. The Lambda function will be created in
 ```us-east-1 (Northern Virginia)``` by default.
...
### Building your own Enviornment based off Alexa Skill Builder Linux Academy Github repo
---
...
2.  **Create repo for your own project**. (Here are [instructions for creating a repo](https://help.github.com/en/articles/create-a-repo).)
    **The Commands Below are for setting up my REPO please Change to the one you crated DO NOT JUST COPY AND PAST** 
    * Mirror lab branch and checkout:

    ```
    git push --mirror https://github.com/AiwarriorLA/LAConsoleLab.git
    git remote set-url origin https://github.com/AiwarriorLA/LAConsoleLab.git
    ```
3.  **Change working directory**.
    ...
    * Make new directory for lab:
    ```
    mkdir AlexaDeveloperConsoleLab
    cd AlexaDeveloperConsoleLab
    git clone https://github.com/AiwarriorLA/LAConsoleLab.git .
    ```
...
4. **Or use ASK CLI**.
    * Navigate to working directory — in my case, it's called `AlexaDeveloperConsoleLab`:
    ...
    * Use ASK CLI to create Alexa skill:
    ...
    ```
     ask new --url https://github.com/AiwarriorLA/LAConsoleLab.git --skill-name AlexaDeveloperConsoleLab
    ```
